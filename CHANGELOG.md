...
- **Refrescos vecinos de escrituras confirmadas:** crear una materia/sección y editar o eliminar una fecha ya no se informan como fallidos si SQLite confirmó la mutación y solo falla la lectura secundaria. El aviso persistente recupera árbol/conteos o próximas fechas sin repetir `INSERT`, `UPDATE` ni `DELETE`; los fallos reales conservan el contrato anterior y AUD-006 protege caches ante respuestas obsoletas. Probado en Android por el autor e integrado en PR #19 (`34b2900`, 2026-09-18); otras mutaciones vecinas permanecen como deuda media y F3 sigue pendiente. [Plan, evidencia y límites](docs/gestion/plan-refrescos-vecinos-2026-09-16.md).
- **Filtros visibles del feed:** fecha y búsqueda removibles fuera del calendario y del drawer; alcance de materia/sección o búsqueda global explícito, con conteos totales conservados. Estados vacíos orientan a quitar filtros; limpiar búsqueda sincroniza el menú sin reactivar su debounce pendiente. Incluye regresiones DOM/store, datos adversariales y 500 notas; el autor confirmó la prueba Android e integró PR #18 (`3898db8`). [Plan, evidencia y límites](docs/gestion/plan-filtros-visibles-2026-09-15.md).
