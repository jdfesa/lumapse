...
> **Estado actual:** Hito 05 quedó cerrado sobre `v0.4.8`. Hito 06 — Entrega Final está activo y ya publicó la segunda beta `v0.5.0`; el [ciclo técnico inmediato](./plan-desarrollo-inmediato-beta-2026-09-12.md) fue aceptado en PR #13. F1 está implementada y pendiente de revisión/validación Mac y teléfono; F2/F3 no comenzaron. Continúa el cierre académico. Ver [`../hitos/hito-06-octubre.md`](../hitos/hito-06-octubre.md).
...
|---|---|---|
| [`plan-desarrollo-inmediato-beta-2026-09-12.md`](./plan-desarrollo-inmediato-beta-2026-09-12.md) | Análisis acotado y próximas sesiones: AUD-008/AUD-009, nuevo AUD-014 y validación del núcleo con 500 notas | ✅ Plan aceptado en PR #13; F1 en revisión |
...
| [`validacion-f1-gate-portable-2026-09-12.md`](./validacion-f1-gate-portable-2026-09-12.md) | Implementación y evidencia por entorno de AUD-008/AUD-009; handoff de revisión | 🔎 F1 en revisión, no integrada |
