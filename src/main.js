  ...
  app.innerHTML = `
    ...
    <aside id="drawer" class="drawer">
      <div class="drawer__header">
        <div class="app-logo">
          <span class="terminal-prompt">user@lumapse</span>&nbsp;<span class="terminal-command">$ search</span>
        </div>
    ...
    <main class="main-layout">
      <div class="feed-container">
        <header class="app-header">
          <div class="app-logo">
            <span class="terminal-prompt">user@lumapse</span>&nbsp;<span class="terminal-command">$ feed</span>
          </div>
